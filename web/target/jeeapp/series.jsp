...
<body>
	<main>
		...
		<c:forEach var="serie" items="${mySeries}">
          ...
          <c:forEach var="season" items="${serie.getSeason()}" varStatus="status">
            <div class="season">
              <h3>
                Season ${status.count}
              </h3>
              <div class="episodes">
                <c:forEach var="episode" items="${season.getEpisode()}" varStatus="status">
                  <div class="ep">
                    <div class="header">
                      <h4>
                        Episode&nbsp;${status.count}: ${episode.getTitle()}
                      </h4>
                      <span>
                        <b>Duration: </b>${episode.getDuration()}
                      </span>
                    </div>
                    <p>
                    ...
                    <div>
                      <span>
                        <p>
                          <b>Reviews: </b>
                          <c:forEach var="review" items="${episode.getReview()}" varStatus="status">
                              <p>&nbsp;&nbsp;&nbsp;${review}</p>
                          </c:forEach>
                        </p>
                      </span>
